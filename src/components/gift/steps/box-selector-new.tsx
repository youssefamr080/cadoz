...
export default function BoxSelector() {
  ...
  // دالة فلترة الصناديق حسب الفئة والسعر
  ...
  // دالة للحصول على عدد الصناديق في كل فئة
    ...
    <div className="space-y-8">
      ...
      {isPageLoading ? (
        ...
        >
          ...
          <p className="text-gray-600 font-medium mb-2">لا توجد صناديق في هذه الفئة</p>
          <p className="text-gray-400 text-sm">جرب فئة سعرية أخرى</p>
        </motion.div>
      ) : (
        <>
          {/* مؤشر النتائج */}
          ...
          >
            ...
            <div className="text-blue-600 text-sm">
              الفئة: <span className="font-semibold">{boxCategories.find(c => c.id === category)?.name}</span>
            </div>
          </motion.div>
