      ...
      >
        ...
        <main className="flex-grow py-6 md:py-10">
          <div className="w-full max-w-[100%] mx-auto px-3 sm:px-4 lg:px-6">
            {/* العنوان */}
            <motion.div className="text-center mb-6 md:mb-10" variants={sectionVariants} role="banner">
            ...
            {/* صندوق الهدايا */}
            <motion.section className="mb-6 md:mb-8" variants={sectionVariants} aria-label="عرض الهدية">
              <GiftContainer />
            </motion.section>
