  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 flex items-center justify-center">
        <LoadingSpinner message="جاري تحميل المنتجات الجديدة..." />
      </div>
    )
  }
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="pb-16">
        {/* بانر الصفحة */}
        <div className="relative h-48 md:h-64 lg:h-80 bg-gradient-to-r from-emerald-400 to-teal-600 overflow-hidden">
          ...
          <div className="container mx-auto px-4 h-full flex flex-col justify-center items-center text-white relative z-10">
            ...
            >
              ...
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-2">وصل حديثاً</h1>
                  ...
                  <div className="py-1">
                    <button
                      className={`w-full text-right px-4 py-2 text-sm ${
                        sortOption === "newest" ? "bg-slate-100 text-emerald-600" : "text-slate-700 hover:bg-slate-50"
                      }`}
                ...
                <motion.div key={product.id} variants={fadeInUp}>
                  ...
                  >
                    <div className="relative pt-[100%] overflow-hidden bg-slate-100">
                      ...
                      />
                      <div className="absolute top-2 left-2 bg-gradient-to-r from-emerald-400 to-teal-600 text-white py-0.5 px-2 text-xs font-semibold rounded-full shadow-sm">
                        جديد
                      </div>
                    </div>
                    <div className="p-3 flex-1 flex flex-col">
                      <h3 className="font-medium text-sm line-clamp-2 mb-1 flex-1 group-hover:text-emerald-600 transition-colors">
                        {product.name}
                      </h3>
