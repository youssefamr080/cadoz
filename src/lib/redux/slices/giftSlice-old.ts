...
import type { Box, GiftProduct, Bag, PersonalMessage, Sweet } from "../../../types/database"
import { getAllBoxes } from "@/lib/actions/box-actions"
...
const giftSlice = createSlice({
  ...
  reducers: {
    ...
    addSelectedSweet: (state, action: PayloadAction<Sweet>) => {
      ...
      if (existingSweet) {
        existingSweet.quantity = (existingSweet.quantity || 1) + 1
      } else {
...
// Aliases للدوال للحفاظ على التوافق مع الأكواد القديمة
export const setSelectedBox = selectBox
export const setSelectedBag = selectBag
export const removeProduct = removeSelectedProduct
export const updateProductQuantity = updateSelectedProductQuantity
export const clearGift = resetGift
export const removeDecoration = () => {} // دالة فارغة للتوافق
